            ...
            <form id="new_task" role="form">
                <div id="wizard1">
                    <section>
                        ...
                        <input onblur="check_ttitle(this.value)" id="title_name" class="form-control" name="title"
                        ...
                        <div class="milestonep" style="display:none"></div>
                    </section>
                    <br>
                    <section>
                    ...
                    <br>
                    <section><label class="form-control-label">Duration (hours): <span
                                    class="tx-danger">*</span></label>
                        <input onblur="check_number(this.value)" class="form-control" name="duration" type="number"
                               required/>
                ...
                <button id="btnSubmit" type="submit" class="btn btn-info btn-block">Add Task</button>
            </form>
    ...
    <script>
        $(document).ready(function (e) {
            $("#new_task").on('submit', (function (e) {
                ...
                $.ajax({
                    url: "<?php echo $website_url; ?>/includes/form_process?value=new_task",
                    type: "POST",
        ...
        function check_ttitle(value) {
            $.post("<?php echo $website_url; ?>/includes/ajax_check_input?value=ttitle", {title: value}, function (data) {
                if (data.length != 0) {
        ...
        function check_task(value) {
            $.post("<?php echo $website_url; ?>/includes/ajax_check_input?value=ctask", {utask: value}, function (data) {
                if (data.length != 0) {
                    $('.milestonep').show();
