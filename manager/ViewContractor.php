    ...
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            <h4 class="card-body-title"
                style="background-color:green;color:white; padding:2px;"><?php echo $omo['fullname']; ?></h4>
            ...
            <table class="table table-white table-responsive mg-b-0 tx-12" style="border: 1px solid red;">
                ...
                <tr>
                    ...
                    <td><a target="_blank" href="<?php echo $omo['photo']; ?>"><img width="50px" height="50px"
                                                                                    src="<?php echo $omo['photo']; ?>"/></a>
                    </td>
                </tr>
                </tbody>
            </table>
