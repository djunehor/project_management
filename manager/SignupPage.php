...
<form id="register_form" role="form">
    <div class="form-group">
        <input type="email" class="form-control" name="email" onblur="check_email(this.value)" id="email"
               placeholder="Enter your email" required>
    </div><!-- form-group -->
    <div class=" alert alert-danger em_error_show" style="display:none"></div>
    <div class="form-group">
        <input type="password" class="form-control" onblur="check_pw(this.value)" name="password" id="password"
               placeholder="Enter your password" required>
    </div><!-- form-group -->
    <div class="form-group">
        <input type="password" class="form-control" onblur="confirm_pw(this.value)" name="confpass" id="confirm_pass"
               placeholder="Renter your password" required>
    </div><!-- form-group -->
    <div class=" alert alert-danger pw_error_show" style="display:none"></div>
    <div class="form-group tx-12">By clicking the Sign Up button below, you agreed to our <a href="../privacy-policy">privacy
            policy</a> and <a href="../terms-and-conditions">terms of use</a> of our website.
    </div>
