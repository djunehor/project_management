    ...
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title"
                style="background-color:green;color:white; padding:2px;"><?php echo $omo['ttitle']; ?></h6>
            ...
            <table class="table table-white table-responsive mg-b-0 tx-12" style="border: 1px solid red;">
                ...
                <tr>
                    ...
                    <?php if ($omo['astatus'] == 0) { ?>
                        <td>
                            <button onclick="start_task(this.value)" id="btnStart" type="submit"
                                    value="<?php echo $omo['id']; ?>" class="btn btn-success">Mark As started
                            </button>
                        </td> <?php } ?>
            ...
            <hr>
            <h3>Fill the Form below if you've completed task</h3>
            <form id="task_com" role="form" enctype="multipart/form-data" style="border: 1px solid green;padding:5px;">
                <section>
                    ...
                    <input onblur="check_number(this.value)" id="number" class="form-control" name="tcost"
                           type="number"/>
