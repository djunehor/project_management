            ...
            <form id="update_profile" role="form" enctype="multipart/form-data">
                <div id="wizard1">
                    <section>
                        ...
                        <input class="form-control" name="fullname" placeholder="Enter full name"
                               value="<?php echo $manager['fullname']; ?>" type="text">
                    </section>
                    <br>
                    <section>
                        ...
                        <input onchange="check_number(this.value)" id="number" class="form-control" name="phone"
                               value="<?php echo $manager['phone']; ?>" type="number"/>
                ...
                <input type="hidden" value="<?php echo $_SESSION['managerID']; ?>" name="managerID">
                <button id="btnSubmit" type="submit" class="btn btn-info btn-block">Update Profile</button>
            </form>
