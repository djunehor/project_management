    ...
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            <h4 class="card-body-title"
                style="background-color:green;color:white; padding:2px;"><?php echo $omo['title']; ?></h4>
            ...
            <table class="table table-white table-responsive mg-b-0 tx-12" style="border: 1px solid red;">
                ...
                <tr>
                    ...
                    <?php if ($omo['projectStatus'] == 0) { ?>
                        <td>
                            <button onclick="start_project(this.value)" id="btnStart" type="submit"
                                    value="<?php echo $omo['projectID']; ?>" class="btn btn-success">Mark As started
                            </button>
                        </td> <?php } ?>
            ...
            <table class="table table-white table-responsive mg-b-0 tx-12" style="border: 1px solid yellow;margin:5px;">
                ...
                while ($om = mysqli_fetch_assoc($g)) {
                    ...
                    <tr class="<?php echo $om['milestoneID']; ?>">
                        ...
                        <td>
                            <a href="ViewMilestone?id=<?php echo $om['milestoneID']; ?>"><?php echo $om['mtitle']; ?></a>
                        </td>
                        ...
                        <td>
                            <button onclick="del_mile(this.value)" id="btnDelete" type="submit"
                                    value="<?php echo $om['milestoneID']; ?>" class="btn btn-danger">Delete
                            </button>
                        </td>
                ...
                <tfoot>
                <tr><a style="text-align:right;" href="NewMilestone">Add New Milestone</a></tr>
                </tfoot>
            </table>
            <br>
            <hr>
            ...
            <table class="table table-white table-responsive mg-b-0 tx-12" style="border: 1px solid yellow;margin:7px;">
                ...
                while ($o = mysqli_fetch_assoc($g)) {
                    ...
                    <tr class="<?php echo $o['taskID']; ?>">
                        ...
                        <td>
                            <form action="EditTask?id=<?php echo $o['taskID']; ?>">
                                <button id="btnEdit" type="submit" class="btn btn-info">Edit</button>
                            </form>
                        </td>
                        <td>
                            <button onclick="del_task(this.value)" id="btnDelete" type="submit"
                                    value="<?php echo $o['taskID']; ?>" class="btn btn-danger">Delete
                            </button>
                        </td>
                ...
                <tfoot>
                <tr><a style="text-align:right;" href="NewTask">Add New Task</a></tr>
                </tfoot>
            </table>
            <br>
            <hr>
