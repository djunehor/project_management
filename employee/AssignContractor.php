            ...
            <form id="assign_task" role="form">
                <div id="wizard1">
                    <section><label class="form-control-label">Project: <span class="tx-danger">*</span></label>
                        ...
                        <div class="taskp" style="display:none"></div>
                    </section>
                    <br>
                    <section>
                        ...
                        <input onblur="check_email(this.value)" id="email" class="form-control" name="email"
                               placeholder="Enter email" type="email" required/>
                        <div class=" alert alert-danger em_error_show" style="display:none"></div>
                        <br><label class="form-control-label">Additional Comments: <span
                                    class="tx-danger">*</span></label>
                        <textarea id="mile_desc" class="form-control" name="comment" placeholder="comments here"
                                  type="text"></textarea>
                ...
                <button id="btnSubmit" type="submit" class="btn btn-info btn-block">Send Invitation</button>
            </form>
