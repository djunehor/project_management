        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                ...
                <form id="add_chat" role="form" enctype="multipart/form-data">
                    ...
                    <input type="hidden" value="<?php echo $employee['email']; ?>" name="senderid">
                    <input type="hidden" value="<?php echo $chat['senderID']; ?>" name="recipientid">
                    <input type="hidden" value="<?php echo $chatid; ?>" name="chatid">
                    <button id="btnSubmit" type="submit" class="btn btn-info btn-block">SEND</button>
                </form>
            ...
            <script>
                ...
                function loadlink() {
                    $('#links').load('<?php echo $website_url; ?>/ajax_form_process?value=load_chat&id=<?php echo $chatid; ?>&senderid=<?php echo $employee['email']; ?>&utype=2', function () {
                        $(this).wrap();
                    });
                }
