            ...
            <form id="new_listing" role="form">
                <div id="wizard1">
                    <section>
                        ...
                        <input onblur="check_title(this.value)" id="title" class="form-control" name="title"
                               placeholder="Enter listing name" type="text" required>
                    ...
                    <section>
                        ...
                        <textarea onblur="check_desc(this.value)" id="info" class="form-control" name="info"
				...
				<h3>General Information</h3>
                    ...
                    <section>
                        ...
                        <div class="milestonep" style="display:none"><br></div>
                        <div class="milep" style="display:none"><br></div>
                        <br>
                        <div class="address" style="display:none"><label class="form-control-label">Address: <span
                    ...
                    <section>
                        ...
                        <input onblur="check_number(this.value)" id="number" class="form-control" name="price"
                ...
                <button id="btnSubmit" type="submit" class="btn btn-info btn-block">Add Listing</button>
            </form>
