...
<form id="update_profile" role="form" enctype="multipart/form-data">
         ...
         <!--     <p>Try the keyboard navigation by clicking arrow left or right!</p> -->
                ...
                <input class="form-control" name="fullname" placeholder="Enter full name" value="<?php echo $manager['fullname']; ?>" type="text">
            </section><br>
            <section>
          <!--    <p>Wonderful transition effects.</p>  -->
         
                <label class="form-control-label">Phone: <span class="tx-danger">*</span></label>
                <input onchange="check_number(this.value)" id="number" class="form-control" name="phone" value="<?php echo $manager['phone']; ?>" type="number" />
