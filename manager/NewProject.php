            ...
            <form id="new_project" role="form">
                <div id="wizard1">
                    <section>
                        ...
                        <input onblur="check_title(this.value)" id="project_name" class="form-control" name="title"
                               placeholder="Enter project name" type="text" required>
                    ...
                    <section>
                        ...
                        <textarea onblur="check_desc(this.value)" id="project_desc" class="form-control" name="desc"
                    ...
                    <section>
                        ...
                        <input onblur="check_date(this.value)" id="date" class="form-control" name="enddate" type="date"
                               required/>
                    ...
                    <section>
                        ...
                        <input onblur="check_number(this.value)" id="number" class="form-control" name="budget"
                ...
                <button id="btnSubmit" type="submit" class="btn btn-info btn-block">Add Project</button>
            </form>
    ...
    <script>
        $(document).ready(function (e) {
            $("#new_project").on('submit', (function (e) {
                ...
                $.ajax({
                    url: "<?php echo $website_url; ?>/includes/form_process?value=new_project",
                    type: "POST",
        ...
        function check_title(value) {
            $.post("<?php echo $website_url; ?>/includes/ajax_check_input?value=title", {title: value}, function (data) {
                if (data.length != 0) {
        ...
        function check_desc(value) {
            $.post("<?php echo $website_url; ?>/includes/ajax_check_input?value=desc", {desc: value}, function (data) {
                if (data.length != 0) {
        ...
        function check_date(value) {
            $.post("<?php echo $website_url; ?>/includes/ajax_check_input?value=date", {udate: value}, function (data) {
                if (data.length != 0) {
