...
include '../views/manager_header.php'; ?>
    ...
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title">All Milestones</h6>
            <p class="mg-b-20 mg-sm-b-30">List of all milestones set by you.</p>
            ...
            <div class="table-wrapper">
                ...
                <table id="datatable1" class="table display responsive nowrap">
                    <thead>
                    <tr>
                        <th class="wd-20p">Milestone Title</th>
...
ON $project_table.projectID=$milestone_table.projectID WHERE $milestone_table.managerID='$managerID'");
                    while ($v = mysqli_fetch_assoc($q8)) {
                        ...
                        <tr class="<?php echo $v['milestoneID']; ?>">
                            <td>
                                <a href="ViewMilestone?id=<?php echo $v['milestoneID']; ?>"><?php echo $v['mtitle']; ?></a>
                            </td>
                            <td><?php echo substr(html_entity_decode(htmlspecialchars_decode($v['mdetail'])), 0, 100); ?>
                                ...
                            </td>
                            <td><?php echo date('d-M-Y', $v['startDate']); ?></td>
                            <td>
                                <form action="EditMilestone?id=<?php echo $v['milestoneID']; ?>">
                                    <button id="btnEdit" type="submit" class="btn btn-info">Edit</button>
                                </form>
                            </td>
                            <td>
                                <button onclick="del_mile(this.value)" id="btnDelete" type="submit"
                                        value="<?php echo $v['milestoneID']; ?>" class="btn btn-danger">Delete
                                </button>
                            </td>
                        </tr>
                        <?php
