...
?>	 <tr>
				...
				<a href="project/<?php echo $v['pslug']; ?>"><?php echo $v['title']; ?></a> 
                     <br><a class="btn btn-success" data-toggle="modal" data-target="#ViewProject<?php echo $v['projectID']; ?>">View Details</a>
      ...
      <div class="modal-dialog modal-dialog-vertical-center" role="document">
        <div class="modal-content bd-0 tx-14">
          <div class="modal-header pd-y-20 pd-x-25">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Project Details</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body pd-25">
            <h4 class="lh-3 mg-b-20"><a class="tx-inverse hover-primary"><?php echo $v['title']; ?></a></h4>
